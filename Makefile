...
#Compilation
CXX = clang++ -std=c++14
CXXFLAGS = -m64 -W -Wall -Wno-missing-field-initializers -g -O0 -D_CRT_SECURE_NO_WARNINGS # -march=native #-fno-fast-math # da provare a inserire nel caso si hanno dei problemi con i calcoli metematici 
